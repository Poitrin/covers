...
<html>
    ...
    <body>
        ...
        <div id="show-creativeWork" class="content scaffold-show" role="main">
            ...
            <f:display bean="creativeWork" />
            <g:form resource="${this.creativeWork}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.creativeWork}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
